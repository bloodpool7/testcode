...
static constexpr int kFrontLeftDriveAbsoluteEncoderPort = 2;
static constexpr int kBackLeftDriveAbsoluteEncoderPort = 3;
static constexpr int kFrontRightDriveAbsoluteEncoderPort = 1;
static constexpr int kBackRightDriveAbsoluteEncoderPort = 0;
...
static constexpr radian_t kFrontLeftDriveAbsoluteEncoderOffsetRad = 0.1068_rad;
static constexpr radian_t kBackLeftDriveAbsoluteEncoderOffsetRad = 2.0546_rad;
static constexpr radian_t kFrontRightDriveAbsoluteEncoderOffsetRad = 6.0695_rad;
static constexpr radian_t kBackRightDriveAbsoluteEncoderOffsetRad = 0.6534_rad;
...
static constexpr units::volt_t kSDrive = 0.5_V;
static constexpr units::volt_t kSTurning = 0.5_V;
